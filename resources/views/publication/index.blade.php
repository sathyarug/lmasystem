...
@section('title')
	...
	<title>LMA Show Publications</title>
            ...
            <div class="container">
              ...
              <div class="card card-transparent">
                <div class="card-header ">
                  <div class="card-title"> <h1><i class="fa fa-bullseye"></i> Publication Management</h1>
              ...
              <!-- END card -->
              <div class="col-xs-12">
                <a href="{{ route('publications.create') }}" class="btn btn-primary" style="margin-bottom: 45px;">Add Publication</a>
              </div>
