                    ...
                    <div class="card-block">
                        ...
                        <div class="form-group-attached">
                            <div class="form-group form-group-default required{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                {!! Form::text('name',$publication->name,array('class' => "form-control" ,'required')) !!}
                        ...
                        <div class="form-group-attached">
                            <div class="form-group form-group-default required{{ $errors->has('type') ? ' has-error' : '' }}">
                                ...
                                {!! Form::select('type',[1=>'General',2=>'Special'],$publication->type, ['class'=>'form-control']) !!}
                        ...
                        <div class="radio radio-danger required{{ $errors->has('language') ? ' has-error' : '' }}">
                            ...
                            <input type="radio" value="{{$language->id}}" name="language_id" id="{{$language->name}}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-group-default required">
                                        ...
                                        <div class="form-input-group {{ $errors->has('c_rate') ? ' has-error' : '' }}">
                                            {!! Form::number('c_rate',$publication->c_rate,array('class'=>'form-control','step'=>'any','required')) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form-group-default input-group required {{ $errors->has('b_rate') ? ' has-error' : '' }}">
                                        ...
                                        <div class="input-group-addon bg-transparent h-c-50">
                                            {!! Form::number('b_rate',$publication->b_rate,array('class'=>'form-control','step'=>'any','required')) !!}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-default input-group required {{ $errors->has('bc1_rate') ? ' has-error' : '' }}">
                                        <div class="form-input-group">
                                            ...
                                            {!! Form::number('bc1_rate',$publication->bc1_rate, array('class'=>'form-control','step'=>'any','required')) !!}
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-default input-group required {{ $errors->has('bc2_rate') ? ' has-error' : '' }}">
                                        <div class="form-input-group">
                                            ...
                                            {!! Form::number('bc2_rate',$publication->bc2_rate, array('class'=>'form-control','step'=>'any','required')) !!}
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-default input-group required {{ $errors->has('c_width') ? ' has-error' : '' }}">
                                        <div class="form-input-group">
                                            ...
                                            {!! Form::number('c_width',$publication->c_width, array('class'=>'form-control','step'=>'any','required')) !!}
                                        </div>
