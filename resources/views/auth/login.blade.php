    ...
    <div class="login-wrapper ">
      ...
      <div class="bg-pic">
        ...
        <div class="bg-caption pull-bottom sm-pull-bottom text-white p-l-20 m-b-20">
          ...
          Welcome to Lanka Monitoring System</h2>
          <p class="small">
            images Displayed are solely for representation purposes only, All work copyright of respective owner, otherwise © 2017 LMA.
          </p>
        </div>
        ...
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
          ...
          <form id="form-login" class="p-t-15" role="form" method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group form-group-default{{ $errors->has('email') ? ' has-error' : '' }}">
              ...
              <div class="controls">
                <input id="email" type="email" name="email" value="{{ old('email') }}"  placeholder="User Name" class="form-control" required>
                @if ($errors->has('email'))
          ...
          <div class="pull-bottom sm-pull-bottom">
            <div class="m-b-30 p-r-80 sm-m-t-20 sm-p-r-15 sm-p-b-20 clearfix">
              <!-- <div class="col-sm-3 col-md-2 no-padding">
                <img alt="" class="m-t-5" data-src="{{asset('assets/img/logo_icon.png')}}" data-src-retina="{{asset('assets/img/logo_2x.png')}}" height="60" src="{{asset('assets/img/logo.png')}}" width="60">
              </div> -->
              <div class="col-sm-9 no-padding m-t-10">
                <p>
                  <small>
                  Create a LMA account. If you have a facebook account, log into it for this
